	...
	$.ajax({
		...
		success: function(retorno){							
			...
			for(i=0;i<retorno.length;i++){
				...
				$('#usuariosCadastrados').append('<tr class="bg-light"><td class="text-secondary">'+ retorno[i].nome_usuario +'</td><td class="text-secondary">'+ retorno[i].cargo_usuario +'</td><td class="text-secondary"><i class="fas fa-ellipsis-v fa-2x" id="'+ retorno[i].id_usuario +'"></i></td><td class="text-secondary"><i class="fas fa-check fa-2x" id="'+ retorno[i].id_usuario +'"></i></td><td class="text-secondary"><i class="fas fa-times-circle fa-2x" id="'+ retorno[i].id_usuario +'"></i></td></tr>');
			}									
		}	
	});
